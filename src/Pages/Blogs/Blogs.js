...
const Blogs = () => {
    return (
        <div className='blog-info'>
            <h4 className='text-3xl font-bold'>Ques-1: What are the different ways to manage a state in a React application?</h4>
            <br />
            ...
            <h4 className='text-3xl font-bold'>Ques-2:How does prototypical inheritance work?</h4>
            <br />
            ...
            <h4 className='text-3xl font-bold'>Ques-3:What is a unit test? Why should we write unit tests?</h4>
            <br />
            <p>
            ...
            <h4 className='text-3xl font-bold'>Ques-4:React vs. Angular vs. Vue?</h4>
            <br />
            <p>Ans:
